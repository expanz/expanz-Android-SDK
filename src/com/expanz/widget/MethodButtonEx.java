...
public class MethodButtonEx extends Button {
	...
	private void init(AttributeSet attrs) {
		TypedArray a = getContext().obtainStyledAttributes(attrs,R.styleable.ButtonEx);
	...
	/**
	 * Register OnClickListener to will execute remote method
	 * and display any messages etc that are returned. 
	 */
	private void registerListener() {
		...
		setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				//hack to stop on onfocuschange events for edit fields happening after this 
